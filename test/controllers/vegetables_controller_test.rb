...
class VegetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create vegetable" do
    assert_difference('Vegetable.count') do
      post vegetables_url, params: { vegetable: { description: @vegetable.description, name: @vegetable.name } }
    end
  ...
  test "should update vegetable" do
    patch vegetable_url(@vegetable), params: { vegetable: { description: @vegetable.description, name: @vegetable.name } }
